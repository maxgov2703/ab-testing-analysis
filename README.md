...
The A/B test compared the conversion rate between the old landing page (control group) and the new landing page (treatment group).
...
A statistical Z-test for proportions was performed:
